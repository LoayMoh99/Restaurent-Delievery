...
public:
	...
	void PrintMessage3(string msg) const; // prints a message in the status bar
	void PrintMessage4(string msg) const; // prints a message in the status bar
	void PrintMessage5(string msg) const; // prints a message in the status bar
	void PrintMessage6(string msg) const; // prints a message in the status bar
	void PrintMessage7(string msg) const; // prints a message in the status bar
	void PrintMessage8(string msg) const; // prints a message in the status bar
	void PrintMessage9(string msg) const; // prints a message in the status bar
	void PrintString(const int iX, const int iY, const string Text); // prints a message in the passed coordinates

	void SortType() ;
	void DeleteOrderFromList(Order *pOrd);//delete passed order from List of Drawing 
